...
const translations = {
  en: {
    ...
    badge_presale: "LGAI PRESALE IS LIVE",
    ...
    btn_buy: "Buy LGAI Token",
    btn_wp: "Read Whitepaper",
    sec_tokenomics: "LGAI Tokenomics",
    sec_tokenomics_sub: "Total Supply: 1,000,000,000 LGAI. Strategically allocated for long-term ecosystem growth.",
    lbl_public: "Public Sale (40%)",
    lbl_liq: "Liquidity Pool (30%)",
    lbl_eco: "Ecosystem (20%)",
    lbl_team: "Team (10%)",
    sec_roadmap: "Strategic Roadmap",
    sec_roadmap_sub: "Our path to global Web3 and AI domination.",
    ph1: "Phase 1",
    ph1_title: "Genesis & Smart Contract Deployment",
    ph1_desc: "Deployment of LGAI on Sepolia. Community building and official presale launch.",
    ph2: "Phase 2",
    ph2_title: "DEX Listing & Global Marketing",
    ph2_desc: "Liquidity generation and listing on Uniswap. Global influencer partnerships.",
    ph3: "Phase 3",
    ph3_title: "AI Council Activation",
    ph3_desc: "Launch of the LGAI powered autonomous AI SaaS platform. AI agents begin managing treasury.",
  ...
  kr: {
    ...
    nav_roadmap: "로드맵",
    btn_connect: "지갑 연결",
    badge_presale: "LGAI 사전 판매(Presale) 진행 중",
    hero_title: "최초의 AI 통치 암호화폐 제국",
    hero_sub: "LGAI는 LegionAI 생태계를 구동하는 핵심 유틸리티 토큰입니다. 자율 AI 에이전트들이 Web3의 미래를 지배합니다.",
    btn_buy: "LGAI 토큰 구매",
    btn_wp: "백서 읽기",
    sec_tokenomics: "LGAI 토크노믹스",
    sec_tokenomics_sub: "총 발행량: 1,000,000,000 LGAI. 장기적인 생태계 성장을 위한 전략적 분배.",
    lbl_public: "퍼블릭 세일 (40%)",
    lbl_liq: "유동성 풀 (30%)",
    lbl_eco: "생태계 기금 (20%)",
    lbl_team: "팀 및 파운더 (10%)",
    sec_roadmap: "전략적 로드맵",
    sec_roadmap_sub: "글로벌 Web3 및 AI 제국을 향한 여정",
    ph1: "1단계",
    ph1_title: "제네시스 & 스마트 컨트랙트 배포",
    ph1_desc: "LGAI 테스트넷 배포 완료. 글로벌 커뮤니티 구축 및 공식 프리세일 런칭.",
    ph2: "2단계",
    ph2_title: "탈중앙화 거래소(DEX) 상장 및 마케팅",
    ph2_desc: "유니스왑 유동성 공급 및 상장. 글로벌 인플루언서 파트너십 체결.",
    ph3: "3단계",
    ph3_title: "AI 통치 위원회 가동",
    ph3_desc: "LGAI 전용 AI SaaS 플랫폼 공식 오픈. AI 에이전트들의 자금 관리 시작.",
  ...
  cn: {
    ...
    nav_roadmap: "路线图",
    btn_connect: "连接钱包",
    badge_presale: "LGAI 预售进行中",
    hero_title: "首个由 AI 统治的加密帝国",
    hero_sub: "LGAI 是驱动 LegionAI 生态系统的核心效用代币。自主 AI 代理网络将优化 Web3 的未来。",
    btn_buy: "购买 LGAI",
    btn_wp: "阅读白皮书",
    sec_tokenomics: "代币经济学",
    sec_tokenomics_sub: "总供应量：1,000,000,000 LGAI。为长期生态增长而战略性分配。",
    lbl_public: "公开销售 (40%)",
    lbl_liq: "流动性池 (30%)",
    lbl_eco: "生态系统 (20%)",
    lbl_team: "团队 (10%)",
    sec_roadmap: "战略路线图",
    sec_roadmap_sub: "通往全球 Web3 与 AI 统治之路。",
    ph1: "第一阶段",
    ph1_title: "创世与智能合约部署",
    ph1_desc: "在 Sepolia 部署 LGAI。社区建设和官方预售启动。",
    ph2: "第二阶段",
    ph2_title: "DEX 上市与全球营销",
    ph2_desc: "Uniswap 流动性生成与上市。全球影响者合作。",
    ph3: "第三阶段",
    ph3_title: "AI 委员会激活",
    ph3_desc: "启动由 LGAI 驱动的自主 AI SaaS 平台。AI 代理开始管理资金库。",
  ...
  jp: {
    ...
    nav_roadmap: "ロードマップ",
    btn_connect: "ウォレット接続",
    badge_presale: "LGAI プレセール開催中",
    hero_title: "初のAI統治暗号通貨帝国",
    hero_sub: "LGAIはLegionAIエコシステムを駆動するネイティブトークンです。自律型AIエージェントがWeb3の未来を最適化します。",
    btn_buy: "LGAIを購入",
    btn_wp: "ホワイトペーパーを読む",
    sec_tokenomics: "トークノミクス",
    sec_tokenomics_sub: "総発行量: 1,000,000,000 LGAI。長期的な成長のための戦略的配分。",
    lbl_public: "パブリックセール (40%)",
    lbl_liq: "流動性プール (30%)",
    lbl_eco: "エコシステム (20%)",
    lbl_team: "チーム (10%)",
    sec_roadmap: "戦略的ロードマップ",
    sec_roadmap_sub: "グローバルWeb3とAI支配への道。",
    ph1: "フェーズ 1",
    ph1_title: "ジェネシス＆スマートコントラクト導入",
    ph1_desc: "SepoliaでのLGAI展開。コミュニティ構築とプレセール開始。",
    ph2: "フェーズ 2",
    ph2_title: "DEX上場とグローバルマーケティング",
    ph2_desc: "Uniswapでの流動性生成と上場。グローバルインフルエンサーとの提携。",
    ph3: "フェーズ 3",
    ph3_title: "AI評議会の活性化",
    ph3_desc: "LGAI駆動の自律型AI SaaSプラットフォームの立ち上げ。AIが資金管理を開始。",
      ...
      <div className="app-layout">
        ...
        <section className="hero-section" id="about">
          ...
          <div className="cta-group">
            <button className="btn-primary" onClick={connectWallet}>{t.btn_buy}</button>
